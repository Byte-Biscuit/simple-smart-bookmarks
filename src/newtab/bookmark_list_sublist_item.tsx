            ...
            <List.Item
                        ...
                        onConfirm={() => {
                            chrome.bookmarks
                                ...
                                .catch((err) => {
                                    ...
                                    messageApi.error(
                                        intl
                                            .get("bookmark-remove-fail")
                                            .d(
                                                "Delete failed, please check if the folder is empty"
                                            )
                                    )
                                })
                        }}
                ...
                ]}>
                {
                    <List.Item.Meta
                        avatar={
                            <Avatar
                                src={<LocalIcon type={"icon-anyinmulu"} />}
                            />
                        }
                        title={
                            <a
                        ...
                        description={
                            <>
                                <p className={"mt-0.5 mb-0 text-blue-500"}>
                                    {intl
                                        .get("bookmark-added-date")
                                        .d("Update")}
                                    :
                                    {dayjs(bookmark.dateAdded).format(
                                        "YYYY-MM-DD"
                                    )}
                                </p>
                            </>
